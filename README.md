...
- `POST /tests/start` to assign up to 50 bots and start a run.
- `GET /tests/{run_id}/metrics` for analytics.
- `WS /ws/runs/{run_id}` for live bot events.
...
The Next.js dashboard renders moving 3D bot orbs, website page nodes, animated counters, a live activity feed, and analytics charts.
